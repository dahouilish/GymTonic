...
@Entity
data class Customer(@Id @GeneratedValue var id: Int? = null, var firstName: String? = null,
                    var lastName: String? = null, var mail: String? = null, var password: String? = null, var date: String? = null,
                    var gender: String? = null, var role: Int? = 1, var authenticated: Boolean? = false)
